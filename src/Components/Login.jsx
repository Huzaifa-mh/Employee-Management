...
const Login = ({ heading }) => {
  const {setProfileData, setLogin } = useContext(UserContext);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Failed to Login User", exception);
      ...
      <div className="h-screen w-screen flex flex-col justify-center items-center bg-gray-100 p-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          ...
          >
            ...
            <button className="group relative inline-flex h-[calc(48px+8px)] items-center justify-center rounded-full bg-slate-800 py-1 pl-14 pr-6 font-medium text-neutral-50">
              <span className="z-10 pr-2">Back to Home</span>
              <div className="absolute left-1 inline-flex h-12 w-12 items-center justify-start rounded-full bg-slate-500 transition-[width] group-hover:w-[calc(100%-8px)]">
